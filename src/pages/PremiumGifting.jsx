...
const productsData = [
  { id: 1, name: "All Seasons Candle - Bubble", type: "bubble", body: "Spring florals, summer citrus, autumn spices, winter warmth", price: 299, image: "/src/assets/featured-1.png", tag: "Bestseller" },
  { id: 2, name: "All Seasons Candle - Peony", type: "peony", body: "Spring florals, summer citrus, autumn spices, winter warmth", price: 299, image: "/src/assets/featured-1.png", tag: "Bestseller" },
  { id: 3, name: "All Seasons Candle - Daisy", type: "daisy", body: "Spring florals, summer citrus, autumn spices, winter warmth", price: 299, image: "/src/assets/featured-1.png", tag: "Bestseller" },
  { id: 4, name: "Party & Celebration ✨", type: "rose", body: "Birthday & special occasions", price: 399, image: "/src/assets/featured-2.png", tag: "Bestseller" },
  { id: 5, name: "Self-Love 🌸", type: "teddy", body: "Aromatherapy and mindfulness", price: 349, image: "/src/assets/featured-3.png", tag: "Bestseller" },
];

const PremiumGifting = ({ addToCart }) => {
    ...
    <div className="all-seasons-page">
      ...
      <div className="hero-video-full">
        ...
        <div className="hero-overlay-full">
          <h1 className="hero-title-full">Premium Gifting</h1>
